...
const CORE_EN = {
  ...
  'Arrêter la réponse (Échap)': 'Stop the reply (Esc)',
  'Une réponse est en cours': 'A reply is in progress',
  'ton message attendra son tour': 'your message will wait its turn',
  'non lu par les agents': 'not read by agents',
  'Retirer': 'Remove',
  'Relancer': 'Restart',
  'Réduire': 'Shrink',
  'Plein écran': 'Full screen',
  'Fermer l\'aperçu': 'Close the preview',
  'Largeur de la prévisualisation': 'Preview width',
  'isolé de ton compte · bibliothèques publiques chargées, aucun autre appel':
    'isolated from your account · public libraries load, nothing else',
  'Code copié.': 'Code copied.',
  'Prévisualisation expirée.': 'Preview expired.',
  ...
  'Transcription en place, et gratuite.': 'Transcription ready, and free.',
  'Une clé gratuite transcrit sans frais :': 'A free key transcribes at no cost:',
  'ajoute ce service dans Fournisseurs de modèles, puis relance la recherche.':
    'add this service under Model providers, then run the search again.',
